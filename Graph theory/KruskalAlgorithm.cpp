/*Kruskal's Algorithm
Explanation: algortihm finds minimal spanning tree by sorting edges by their
weight and then taking every edge that does not create a cycle.
Source: https://cp-algorithms.com/graph/mst_kruskal.html
Complexity: O(Elog(E))
